...
// function checkMatchIdAndDisableButtons() {
    // If no matchId exists, disable all buttons
//    if (!matchId) {
...
//			if (button.getAttribute('onclick') === 'startInnings()') {
//              return;
//			}
...
//        alert("Please complete match setup first to generate a Match ID.");
//    }
//}
